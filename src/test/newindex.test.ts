...
describe('CycleManager', () => {
  ...
  let isCycleInProgress : boolean;
  let ramAtDoor : number;
  let ejectDoorSignal : number;
  let powerStatus : number;
  let ramMoving:number;
  let hydraullicPressure : number;
  let HydraullicPressureThreshold : number;
  let mockManager: any;
