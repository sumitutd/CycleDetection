...
class CycleManager extends events_1.EventEmitter {
    ...
    // invalidCycle(ramAtDoor: number,hydraulicPressure: number,powerStatus: number, isCycleInProgress:boolean) {
    //   console.log("Hydraullic Pressure threshold: ", this.hydraulicPressureThreshold);
    //   if ((isCycleInProgress && powerStatus === 0) || (ramAtDoor === 1 && hydraulicPressure <= this.hydraulicPressureThreshold && isCycleInProgress)) {
